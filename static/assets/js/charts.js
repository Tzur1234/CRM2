    ...
    (e(13).inspectSource = function (t) {
      ...
      (t.exports = function (t, n, e, c) {
        ...
        u && (i(e, "name") || o(e, "name", n)),
          t[n] !== e &&
            (u && (i(e, a) || o(e, a, t[n] ? "" + t[n] : s.join(String(n)))),
            t === r
              ? (t[n] = e)
              : c
              ? t[n]
    ...
    var r = e(14),
      ...
      a = function (t) {
        var n = t.data("update"),
          e = $(t.data("target")).data("chart");
        if (
          (o(e, n), void 0 !== t.data("prefix") || void 0 !== t.data("suffix"))
        ) {
          var r = t.data("prefix") ? t.data("prefix") : "",
            i = t.data("suffix") ? t.data("suffix") : "";
          void 0 !== e.options.scales &&
            (e.options.scales.yAxes[0].ticks.callback = function (t) {
              ...
              return (
                1 < n.datasets.length &&
                  (a +=
                    ...
                    e +
                    "</span>"),
                a + '<span class="popover-body-value">' + r + o + i + "</span>"
              );
            });
        }
        e.update();
                ...
                (o += '<div class="arrow"></div>'),
                  ...
                  r.forEach(function (n, e) {
                    var i =
                        ...
                        t.labelColors[e].backgroundColor +
                        '"></span>',
                      a =
                        1 < r.length
              ...
              return (
                1 < n.datasets.length &&
                  (o +=
                    ...
                    e +
                    "</span>"),
                o + '<span class="popover-body-value">' + r + "</span>"
              );
            },
          },
        },
      ...
      s = {
        ...
        legendCallback: function (t) {
          var n = t.data,
            e = "";
          return (
            n.labels.forEach(function (t, r) {
              var o = n.datasets[0].backgroundColor[r];
              (e += '<span class="chart-legend-item">'),
                (e +=
      ...
      u = {
        settings: settings,
        init: function () {
          o(Chart, { defaults: { global: c, doughnut: s } }),
            Chart.scaleService.updateScaleDefaults("linear", {
              gridLines: {
                ...
                color:
                  "dark" == settings.charts.colorScheme
                    ? settings.colors.gray[900]
                    : settings.colors.gray[100],
                drawBorder: !1,
                drawTicks: !1,
                lineWidth: 0,
                zeroLineWidth: 0,
    ...
    t.exports = function (t, n, e, y, v, h, g) {
      ...
      if (
        (T &&
          ...
          x.next &&
          (u(x, k, !0), r || "function" == typeof x[f] || a(x, f, d)),
        O &&
          _ &&
          "values" !== _.name &&
          ((L = !0),
