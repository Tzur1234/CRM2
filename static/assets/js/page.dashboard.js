      ...
      var e = function (e) {
        ...
        (r = Chart.helpers.merge(
          ...
          (a = a || {
            ...
            datasets: [
              { label: "Earnings", data: [400, 200, 450, 460, 220, 380, 800] },
            ],
          }),
                    ...
                    return (
                      1 < t.datasets.length &&
                        (o +=
                          ...
                          r +
                          "</span>"),
                      o + '<span class="popover-body-value">$' + a + "k</span>"
                    );
                  },
                },
              },
          ...
          (a = Chart.helpers.merge(
            {
              elements: {
                ...
                point: { borderColor: settings.colors.success[700] },
              },
            },
            a
          )),
          ...
          var t =
            ...
            r =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : {};
          r = Chart.helpers.merge(
            { barRoundness: 1.2, scales: { xAxes: [{ maxBarThickness: 15 }] } },
            r
          );
          var a = {
            labels: ["10-17", "18-30", "35-45", "46-60", "61-79", "80+"],
            datasets: [
              { label: "Female", data: [25, 20, 30, 22, 17, 10] },
              {
                label: "Male",
